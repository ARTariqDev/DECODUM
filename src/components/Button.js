...
const Button = ({
  ...
  return (
    <button
      ...
      onClick={handleClick}
      className="relative px-6 py-2 rounded-md text-white font-medium overflow-hidden transition duration-150 active:scale-95 border border-[#fff8de]/20 backdrop-blur-md cursor-pointer"
      style={{
        background: `${color}`,
      }}
    >
